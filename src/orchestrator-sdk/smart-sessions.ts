...
export default async function main({
  ...
  const session: Session = {
    ...
    actions: [
      {
        actionTarget: "0x0000000000000000000000000000000000000001" as Address,
        actionTargetSelector: "0x00000001" as Hex,
        actionPolicies: [getSudoPolicy()],
      },
    ],
    chainId: BigInt(targetChain.id), // TODO is this fine?
